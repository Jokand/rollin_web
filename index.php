	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<!-- <article class="post">
				...
				<a href="single.php" class="image featured"><img src="images/pic03.jpg" alt="" /></a>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- <section id="intro">
				...
				<header>
					...
					<p>Another fine responsive site template by <a href="http://php5up.net">php5 UP</a></p>
				</header>
			</section> -->
		...
		<!-- <section id="footer">
								...
								<p class="copyright">&copy; Untitled. Design: <a href="http://php5up.net">php5 UP</a>. Images: <a href="http://unsplash.com">Unsplash</a>.</p>
							</section> 
